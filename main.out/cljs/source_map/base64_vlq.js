...
var digit_6923 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_6924__$1 = (vlq >>> (5));
while(true){
if((vlq_6924__$1 > (0))){
var digit_6925__$1 = (digit_6923 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_6925__$1));

var G__6926 = (vlq_6924__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__6927 = (vlq_6924__$1 >>> (5));
digit_6923 = G__6926;
vlq_6924__$1 = G__6927;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_6923));
}
break;
}
...
var G__6928 = i__$1;
var G__6929 = result__$1;
var G__6930 = shift__$1;
i = G__6928;
result = G__6929;
shift = G__6930;
continue;
